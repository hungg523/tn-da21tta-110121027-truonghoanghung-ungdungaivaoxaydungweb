...
{
    public class DeleteUserAddressHandler : IRequestHandler<DeleteUserAddressRequest, Result<object>>
    {
        private readonly IUserAddressRepository userAddressRepository;
        private readonly ICacheService cacheService;

        public DeleteUserAddressHandler(IUserAddressRepository userAddressRepository, ICacheService cacheService)
        {
            this.userAddressRepository = userAddressRepository;
            this.cacheService = cacheService;
        }

        public async Task<Result<object>> Handle(DeleteUserAddressRequest request, CancellationToken cancellationToken)
        {
