...
{
    public class FacebookLoginHandler : IRequestHandler<FacebookLoginRequest, Result<LoginDTO>>
    {
        private readonly IAuthRepository authRepository;
        private readonly IUserRepository userRepository;
        private readonly IJwtService jwtService;

        public FacebookLoginHandler(IAuthRepository authRepository, IUserRepository userRepository, IJwtService jwtService)
        {
        ...
        public async Task<Result<LoginDTO>> Handle(FacebookLoginRequest request, CancellationToken cancellationToken)
        {
